...
$(`<div class="uzr fl corner borderg mm bid1camh6so110" style="border-radius:5px;margin-bottom:-2px;width:99.5%;padding:0px; background-color:white;">
      ...
      <div class="uzr fl" style="padding:0px;width:80%">
        ...
        <br>
        <div style="padding:0px; width:100%;" class=" u-msg   break  fl">نتمنى لـك قضـّاء وقت ممتع :) ، ..&nbsp;</div>
      </div>
&nbsp;<br />
&nbsp;</div>
      </div>
    <a  style="margin-top:-20px;padding:4px;float:right;border-radius:100px;" class="btn minix btn-danger fa fa-spin fa-heart fr"></a></div>`).insertBefore('div#d2bc'),$(`<img src ="" etclass="fr" style="width:100%;margin-top: 1px;">
</div>
<div id="asim10"><center><a id="asim33" href="https://raw.githack.com/zagcha/Kazz/master/Z.html" target="_blank" type="button" style=" width: 22%; margin: 2px;" class="btn btn-primary btn-sm">التطبيق</a><a id="asim33" href="sub.html" target="_blank" type="button" style=" width: 22%; margin: 2px;" class="btn btn-primary btn-sm">اشتراكات</a>
<a id="asim33" href="rules.html" target="_blank" type="button" style=" width: 22%; margin: 2px;" class="btn btn-primary btn-sm">القوانين</a><div style=" width: 22%; "  id="asim33" class="btn btn-primary btn-sm" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">اتصل بنا</div><div class="collapse" id="collapseExample"><center><div class="well"><p lass="bg-primary">  </p>راسلنا تليكرام اذا جنت محظور </p>  <i class="fa fa-comment"></i> Telegram <i class="fa fa-share"></i> @Zagiq </p>  <i class="fa fa-comment"></i> Telegram <i class="fa fa-share"></i> @mr020a </p>  <i class="fa fa fa-comment"></i> Telegram <i class="fa fa-share"></i>  </div></div><center></div></div><center></div>`).insertBefore('.nav-tabs'),$('.checkbox label').html(`<input id="stealth" type="checkbox" value=""><img style="width: 22px;" src="sico/1597255945926.png" width="100%">`),$('.nav-tabs').addClass('fl').css('width','100%'),$('.tc span[class="fa fl"]').addClass('fa-check'),nopm=!0,$(`<link rel="stylesheet" type="text/css" href=""><?php
session_start(); 
...
.btn-sm, .btn-sm {font-family: 'jazeera',FontAwesome;font-size: 13px!important;padding: 3px!important;text-align: center!important;border-radius: 10px 10px 10px 10px;width: 100%;background-image: url();}
.asim111 {
...
#collapseExample {font-family: 'jazeera',FontAwesome;font-size: 11px!important;padding: 2px!important;text-align: center!important;width: 100%;background-image: url();
